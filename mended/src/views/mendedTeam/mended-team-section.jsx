...
const MendedTeamSection = () => {
  ...
  return (
    <div className="team-bg-2 mt-40 h-auto lg:pb-56 md:pb-48 pb-24 relative">
      <Container>
        <div className="flex justify-center">
          <div className=" absolute -top-7">
            <TeamCard data={obj} />
          </div>
          <div className="grid lg:grid-cols-3 grid-cols-2 justify-center mt-[190px] lg:gap-14 md:gap-14 gap-5">
            {TEAM_ARR.map((team) => (
